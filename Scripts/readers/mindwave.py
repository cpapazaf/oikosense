            ...
            while payload:
                ...
                if ord(code) < 0x80:
                    ...
                    if code == POOR_SIGNAL:
                        ...
                        print 'WARNING: Unhandled single-byte code: code %r, payload %r' % (code, originalPayload)
                else:
...
##                        self.headset.headset_id = value.encode('hex')
                        ...
                        print 'WARNING: Unhandled multi-byte code: code %r, payload %r' % (code, originalPayload)
